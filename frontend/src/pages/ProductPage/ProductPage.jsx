          ...
          product.map((products) => (
            <div key={products._id}>
              <nav className="breadcrumb">
                ...
                <a href="/accessories">Accessories</a> &gt; {products.category}
              </nav>
              <div className="mainSection">
                <div className="product-images">
                  ...
                  <div className="thumbnail-images">
                    <img src={products.images[0]} alt="Product thumbnail" />
                    <img src={products.images[0]} alt="Product thumbnail" />
                    <img src={products.images[0]} alt="Product thumbnail" />
                    <img src={products.images[0]} alt="Product thumbnail" />
                    <img src={products.images[0]} alt="Product thumbnail" />
                ...
                <div className="product-details">
                  <div className="product-info">
                    ...
                    <div className="reviews">
                      <span>
                        {products.rating}★ {products.numReviews} reviews
                      </span>
                    </div>
                    <div className="price">
                      <span className="original-price">
                        {products.discount === 0 ? "" : `${products.price} ETB`}
                      </span>
                      ...
                      <span className="discount">
                        -
                        {((products.discount / products.price) * 100).toFixed(
                          2
                        )}
                        %
                      </span>
